...
[UninstallDelete]
Type: filesandordirs; Name: "{userappdata}\Marten"
...
var
  ResultCode: Integer;
begin
  Exec('taskkill', '/F /IM marten.exe', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Exec('net', 'stop "MartenTunnelService"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Exec('sc.exe', 'delete "MartenTunnelService"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Result := True;
end;
