...
class ProfileEntries extends Table
  ...
  late final GeneratedColumn<String> subscriptionEndpoints =
  ...
  late final GeneratedColumn<String> currentSubscriptionEndpoint =
      GeneratedColumn<String>(
  ...
  late final GeneratedColumn<String> unavailableSubscriptionEndpoints =
      GeneratedColumn<String>(
        'unavailable_subscription_endpoints',
        aliasedName,
        true,
        type: DriftSqlType.string,
        requiredDuringInsert: false,
  ...
  List<GeneratedColumn> get $columns => [
    ...
    unavailableSubscriptionEndpoints,
    populatedHeaders,
    profileOverride,
    userOverride,
  ];
  ...
  ProfileEntriesData map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ProfileEntriesData(
      ...
      subscriptionEndpoints: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}subscription_endpoints'],
      ),
      currentSubscriptionEndpoint: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}current_subscription_endpoint'],
      ),
      unavailableSubscriptionEndpoints: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}unavailable_subscription_endpoints'],
      ),
...
class ProfileEntriesData extends DataClass
  ...
  final String? subscriptionEndpoints;
  final String? currentSubscriptionEndpoint;
  final String? unavailableSubscriptionEndpoints;
  ...
  const ProfileEntriesData({
    ...
    this.unavailableSubscriptionEndpoints,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || subscriptionEndpoints != null) {
      map['subscription_endpoints'] = Variable<String>(subscriptionEndpoints);
    }
    if (!nullToAbsent || currentSubscriptionEndpoint != null) {
      map['current_subscription_endpoint'] = Variable<String>(
        currentSubscriptionEndpoint,
      );
    }
    if (!nullToAbsent || unavailableSubscriptionEndpoints != null) {
      map['unavailable_subscription_endpoints'] = Variable<String>(
        unavailableSubscriptionEndpoints,
      );
    }
  ...
  ProfileEntriesCompanion toCompanion(bool nullToAbsent) {
    return ProfileEntriesCompanion(
      ...
      supportUrl: supportUrl == null && nullToAbsent
          ? const Value.absent()
          : Value(supportUrl),
      subscriptionEndpoints: subscriptionEndpoints == null && nullToAbsent
          ? const Value.absent()
          : Value(subscriptionEndpoints),
      currentSubscriptionEndpoint:
          currentSubscriptionEndpoint == null && nullToAbsent
          ? const Value.absent()
          : Value(currentSubscriptionEndpoint),
      unavailableSubscriptionEndpoints:
          unavailableSubscriptionEndpoints == null && nullToAbsent
          ? const Value.absent()
          : Value(unavailableSubscriptionEndpoints),
  ...
  factory ProfileEntriesData.fromJson(
    ...
    return ProfileEntriesData(
      ...
      subscriptionEndpoints: serializer.fromJson<String?>(
        json['subscriptionEndpoints'],
      ),
      currentSubscriptionEndpoint: serializer.fromJson<String?>(
        json['currentSubscriptionEndpoint'],
      ),
      unavailableSubscriptionEndpoints: serializer.fromJson<String?>(
        json['unavailableSubscriptionEndpoints'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'subscriptionEndpoints': serializer.toJson<String?>(
        subscriptionEndpoints,
      ),
      'currentSubscriptionEndpoint': serializer.toJson<String?>(
        currentSubscriptionEndpoint,
      ),
      'unavailableSubscriptionEndpoints': serializer.toJson<String?>(
        unavailableSubscriptionEndpoints,
      ),
  ...
  ProfileEntriesData copyWith({
    ...
    Value<String?> subscriptionEndpoints = const Value.absent(),
    Value<String?> currentSubscriptionEndpoint = const Value.absent(),
    Value<String?> unavailableSubscriptionEndpoints = const Value.absent(),
    ...
    subscriptionEndpoints: subscriptionEndpoints.present
        ? subscriptionEndpoints.value
        : this.subscriptionEndpoints,
    currentSubscriptionEndpoint: currentSubscriptionEndpoint.present
        ? currentSubscriptionEndpoint.value
        : this.currentSubscriptionEndpoint,
    unavailableSubscriptionEndpoints: unavailableSubscriptionEndpoints.present
        ? unavailableSubscriptionEndpoints.value
        : this.unavailableSubscriptionEndpoints,
  ...
  ProfileEntriesData copyWithCompanion(ProfileEntriesCompanion data) {
    return ProfileEntriesData(
      ...
      supportUrl: data.supportUrl.present
          ...
          : this.supportUrl,
      subscriptionEndpoints: data.subscriptionEndpoints.present
          ? data.subscriptionEndpoints.value
          : this.subscriptionEndpoints,
      currentSubscriptionEndpoint: data.currentSubscriptionEndpoint.present
          ? data.currentSubscriptionEndpoint.value
          : this.currentSubscriptionEndpoint,
      unavailableSubscriptionEndpoints:
          data.unavailableSubscriptionEndpoints.present
          ? data.unavailableSubscriptionEndpoints.value
          : this.unavailableSubscriptionEndpoints,
  ...
  String toString() {
    return (StringBuffer('ProfileEntriesData(')
          ...
          ..write('subscriptionEndpoints: $subscriptionEndpoints, ')
          ..write('currentSubscriptionEndpoint: $currentSubscriptionEndpoint, ')
          ..write(
            'unavailableSubscriptionEndpoints: $unavailableSubscriptionEndpoints, ',
          )
  ...
  bool operator ==(Object other) =>
      ...
      (other is ProfileEntriesData &&
          ...
          other.subscriptionEndpoints == this.subscriptionEndpoints &&
          other.currentSubscriptionEndpoint ==
              this.currentSubscriptionEndpoint &&
          other.unavailableSubscriptionEndpoints ==
              this.unavailableSubscriptionEndpoints &&
...
class ProfileEntriesCompanion extends UpdateCompanion<ProfileEntriesData> {
  ...
  final Value<String?> subscriptionEndpoints;
  final Value<String?> currentSubscriptionEndpoint;
  final Value<String?> unavailableSubscriptionEndpoints;
  ...
  const ProfileEntriesCompanion({
    ...
    this.subscriptionEndpoints = const Value.absent(),
    this.currentSubscriptionEndpoint = const Value.absent(),
    this.unavailableSubscriptionEndpoints = const Value.absent(),
  ...
  static Insertable<ProfileEntriesData> custom({
    ...
    Expression<String>? subscriptionEndpoints,
    Expression<String>? currentSubscriptionEndpoint,
    Expression<String>? unavailableSubscriptionEndpoints,
    ...
    return RawValuesInsertable({
      ...
      if (currentSubscriptionEndpoint != null)
        'current_subscription_endpoint': currentSubscriptionEndpoint,
      if (unavailableSubscriptionEndpoints != null)
        'unavailable_subscription_endpoints': unavailableSubscriptionEndpoints,
  ...
  ProfileEntriesCompanion copyWith({
    ...
    Value<String?>? subscriptionEndpoints,
    Value<String?>? currentSubscriptionEndpoint,
    Value<String?>? unavailableSubscriptionEndpoints,
    ...
    return ProfileEntriesCompanion(
      ...
      subscriptionEndpoints:
          subscriptionEndpoints ?? this.subscriptionEndpoints,
      currentSubscriptionEndpoint:
          currentSubscriptionEndpoint ?? this.currentSubscriptionEndpoint,
      unavailableSubscriptionEndpoints:
          unavailableSubscriptionEndpoints ??
          this.unavailableSubscriptionEndpoints,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (subscriptionEndpoints.present) {
      map['subscription_endpoints'] = Variable<String>(
        subscriptionEndpoints.value,
      );
    }
    if (currentSubscriptionEndpoint.present) {
      map['current_subscription_endpoint'] = Variable<String>(
        currentSubscriptionEndpoint.value,
      );
    }
    if (unavailableSubscriptionEndpoints.present) {
      map['unavailable_subscription_endpoints'] = Variable<String>(
        unavailableSubscriptionEndpoints.value,
      );
    }
