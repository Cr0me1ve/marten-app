...
class Shape5 extends i0.VersionedTable {
  ...
  i1.GeneratedColumn<String> get supportUrl =>
      columnsByName['support_url']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get subscriptionEndpoints =>
      columnsByName['subscription_endpoints']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get currentSubscriptionEndpoint =>
      columnsByName['current_subscription_endpoint']!
          as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get unavailableSubscriptionEndpoints =>
      columnsByName['unavailable_subscription_endpoints']!
          as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get populatedHeaders =>
      columnsByName['populated_headers']! as i1.GeneratedColumn<String>;
  i1.GeneratedColumn<String> get profileOverride =>
