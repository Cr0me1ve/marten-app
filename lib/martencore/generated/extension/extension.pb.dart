...
import '../v2/hcommon/common.pbenum.dart' as $2;
...
class ExtensionActionResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ExtensionActionResult', package: const $pb.PackageName(_omitMessageNames ? '' : 'extension'), createEmptyInstance: create)
    ...
    ..e<$2.ResponseCode>(2, _omitFieldNames ? '' : 'code', $pb.PbFieldType.OE, defaultOrMaker: $2.ResponseCode.OK, valueOf: $2.ResponseCode.valueOf, enumValues: $2.ResponseCode.values)
  ...
  @$pb.TagNumber(2)
  $2.ResponseCode get code => $_getN(1);
  @$pb.TagNumber(2)
  set code($2.ResponseCode v) { setField(2, v); }
  @$pb.TagNumber(2)
