...
import '../martenoptions/marten_options.pb.dart' as $9;
...
class ProfileEntity extends $pb.GeneratedMessage {
  factory ProfileEntity({
    ...
    $9.MartenOptions? overrideMartenOptions,
  }) {
    final $result = create();
    if (id != null) {
      $result.id = id;
    ...
    if (overrideMartenOptions != null) {
      $result.overrideMartenOptions = overrideMartenOptions;
    }
    return $result;
  }
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ProfileEntity', package: const $pb.PackageName(_omitMessageNames ? '' : 'profile'), createEmptyInstance: create)
    ...
    ..aOM<$9.MartenOptions>(8, _omitFieldNames ? '' : 'overrideMartenOptions', subBuilder: $9.MartenOptions.create)
  ...
  @$pb.TagNumber(8)
  $9.MartenOptions get overrideMartenOptions => $_getN(6);
  @$pb.TagNumber(8)
  set overrideMartenOptions($9.MartenOptions v) { setField(8, v); }
  @$pb.TagNumber(8)
  $core.bool hasOverrideMartenOptions() => $_has(6);
  @$pb.TagNumber(8)
  void clearOverrideMartenOptions() => clearField(8);
  @$pb.TagNumber(8)
  $9.MartenOptions ensureOverrideMartenOptions() => $_ensure(6);
}
