...
final $typed_data.Uint8List pauseRequestDescriptor = $convert.base64Decode(
    'CgxQYXVzZVJlcXVlc3QSJAoEbW9kZRgBIAEoDjIQLmhjb3JlLlNldHVwTW9kZVIEbW9kZQ==');
...
const SystemInfo$json = {
  ...
  '2': [
    ...
    {'1': 'turncoat_rx_proof_count', '3': 12, '4': 1, '5': 3, '10': 'turncoatRxProofCount'},
    {'1': 'turncoat_active_sessions', '3': 13, '4': 1, '5': 5, '10': 'turncoatActiveSessions'},
    {'1': 'turncoat_ready_sessions', '3': 14, '4': 1, '5': 5, '10': 'turncoatReadySessions'},
    {'1': 'turncoat_health_report_count', '3': 15, '4': 1, '5': 3, '10': 'turncoatHealthReportCount'},
  ],
};
...
final $typed_data.Uint8List systemInfoDescriptor = $convert.base64Decode(
    ...
    '5jdXJyZW50UHJvZmlsZRI1Chd0dXJuY29hdF9yeF9wcm9vZl9jb3VudBgMIAEoA1IUdHVybmNv'
    'YXRSeFByb29mQ291bnQSOAoYdHVybmNvYXRfYWN0aXZlX3Nlc3Npb25zGA0gASgFUhZ0dXJuY2'
    '9hdEFjdGl2ZVNlc3Npb25zEjYKF3R1cm5jb2F0X3JlYWR5X3Nlc3Npb25zGA4gASgFUhV0dXJu'
    'Y29hdFJlYWR5U2Vzc2lvbnMSPwocdHVybmNvYXRfaGVhbHRoX3JlcG9ydF9jb3VudBgPIAEoA1'
    'IZdHVybmNvYXRIZWFsdGhSZXBvcnRDb3VudA==');

@$core.Deprecated('Use turncoatRouteEvidenceDescriptor instead')
const TurncoatRouteEvidence$json = {
  '1': 'TurncoatRouteEvidence',
  '2': [
    {'1': 'rx_proof_count', '3': 1, '4': 1, '5': 3, '10': 'rxProofCount'},
    {'1': 'active_sessions', '3': 2, '4': 1, '5': 5, '10': 'activeSessions'},
    {'1': 'ready_sessions', '3': 3, '4': 1, '5': 5, '10': 'readySessions'},
    {'1': 'health_report_count', '3': 4, '4': 1, '5': 3, '10': 'healthReportCount'},
  ],
};

/// Descriptor for `TurncoatRouteEvidence`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List turncoatRouteEvidenceDescriptor = $convert.base64Decode(
    'ChVUdXJuY29hdFJvdXRlRXZpZGVuY2USJAoOcnhfcHJvb2ZfY291bnQYASABKANSDHJ4UHJvb2'
    'ZDb3VudBInCg9hY3RpdmVfc2Vzc2lvbnMYAiABKAVSDmFjdGl2ZVNlc3Npb25zEiUKDnJlYWR5'
    'X3Nlc3Npb25zGAMgASgFUg1yZWFkeVNlc3Npb25zEi4KE2hlYWx0aF9yZXBvcnRfY291bnQYBC'
    'ABKANSEWhlYWx0aFJlcG9ydENvdW50');
...
@$core.Deprecated('Use changeMartenSettingsRequestDescriptor instead')
const ChangeMartenSettingsRequest$json = {
  '1': 'ChangeMartenSettingsRequest',
  '2': [
    {'1': 'marten_settings_json', '3': 1, '4': 1, '5': 9, '10': 'martenSettingsJson'},
  ],
};

/// Descriptor for `ChangeMartenSettingsRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List changeMartenSettingsRequestDescriptor = $convert.base64Decode(
    'ChtDaGFuZ2VNYXJ0ZW5TZXR0aW5nc1JlcXVlc3QSMAoUbWFydGVuX3NldHRpbmdzX2pzb24YAS'
    'ABKAlSEm1hcnRlblNldHRpbmdzSnNvbg==');
...
const SelectOutboundRequest$json = {
  ...
  '2': [
    ...
    {'1': 'skip_probe', '3': 3, '4': 1, '5': 8, '10': 'skipProbe'},
  ],
};
...
final $typed_data.Uint8List selectOutboundRequestDescriptor = $convert.base64Decode(
    ...
    'xvdXRib3VuZF90YWcYAiABKAlSC291dGJvdW5kVGFnEh0KCnNraXBfcHJvYmUYAyABKAhSCXNr'
    'aXBQcm9iZQ==');
