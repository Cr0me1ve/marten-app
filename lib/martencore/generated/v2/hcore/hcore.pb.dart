...
class PauseRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'PauseRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'hcore'), createEmptyInstance: create)
...
class SystemInfo extends $pb.GeneratedMessage {
  factory SystemInfo({
    ...
    $fixnum.Int64? turncoatRxProofCount,
    $core.int? turncoatActiveSessions,
    $core.int? turncoatReadySessions,
    $fixnum.Int64? turncoatHealthReportCount,
  }) {
    final $result = create();
    if (memory != null) {
    ...
    if (turncoatRxProofCount != null) {
      $result.turncoatRxProofCount = turncoatRxProofCount;
    }
    if (turncoatActiveSessions != null) {
      $result.turncoatActiveSessions = turncoatActiveSessions;
    }
    if (turncoatReadySessions != null) {
      $result.turncoatReadySessions = turncoatReadySessions;
    }
    if (turncoatHealthReportCount != null) {
      $result.turncoatHealthReportCount = turncoatHealthReportCount;
    }
    return $result;
  }
  SystemInfo._() : super();
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SystemInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'hcore'), createEmptyInstance: create)
    ...
    ..aInt64(12, _omitFieldNames ? '' : 'turncoatRxProofCount')
    ..a<$core.int>(13, _omitFieldNames ? '' : 'turncoatActiveSessions', $pb.PbFieldType.O3)
    ..a<$core.int>(14, _omitFieldNames ? '' : 'turncoatReadySessions', $pb.PbFieldType.O3)
    ..aInt64(15, _omitFieldNames ? '' : 'turncoatHealthReportCount')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(12)
  $fixnum.Int64 get turncoatRxProofCount => $_getI64(11);
  @$pb.TagNumber(12)
  set turncoatRxProofCount($fixnum.Int64 v) { $_setInt64(11, v); }
  @$pb.TagNumber(12)
  $core.bool hasTurncoatRxProofCount() => $_has(11);
  @$pb.TagNumber(12)
  void clearTurncoatRxProofCount() => clearField(12);

  @$pb.TagNumber(13)
  $core.int get turncoatActiveSessions => $_getIZ(12);
  @$pb.TagNumber(13)
  set turncoatActiveSessions($core.int v) { $_setSignedInt32(12, v); }
  @$pb.TagNumber(13)
  $core.bool hasTurncoatActiveSessions() => $_has(12);
  @$pb.TagNumber(13)
  void clearTurncoatActiveSessions() => clearField(13);

  @$pb.TagNumber(14)
  $core.int get turncoatReadySessions => $_getIZ(13);
  @$pb.TagNumber(14)
  set turncoatReadySessions($core.int v) { $_setSignedInt32(13, v); }
  @$pb.TagNumber(14)
  $core.bool hasTurncoatReadySessions() => $_has(13);
  @$pb.TagNumber(14)
  void clearTurncoatReadySessions() => clearField(14);

  @$pb.TagNumber(15)
  $fixnum.Int64 get turncoatHealthReportCount => $_getI64(14);
  @$pb.TagNumber(15)
  set turncoatHealthReportCount($fixnum.Int64 v) { $_setInt64(14, v); }
  @$pb.TagNumber(15)
  $core.bool hasTurncoatHealthReportCount() => $_has(14);
  @$pb.TagNumber(15)
  void clearTurncoatHealthReportCount() => clearField(15);
}

class TurncoatRouteEvidence extends $pb.GeneratedMessage {
  factory TurncoatRouteEvidence({
    $fixnum.Int64? rxProofCount,
    $core.int? activeSessions,
    $core.int? readySessions,
    $fixnum.Int64? healthReportCount,
  }) {
    final $result = create();
    if (rxProofCount != null) {
      $result.rxProofCount = rxProofCount;
    }
    if (activeSessions != null) {
      $result.activeSessions = activeSessions;
    }
    if (readySessions != null) {
      $result.readySessions = readySessions;
    }
    if (healthReportCount != null) {
      $result.healthReportCount = healthReportCount;
    }
    return $result;
  }
  TurncoatRouteEvidence._() : super();
  factory TurncoatRouteEvidence.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory TurncoatRouteEvidence.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TurncoatRouteEvidence', package: const $pb.PackageName(_omitMessageNames ? '' : 'hcore'), createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'rxProofCount')
    ..a<$core.int>(2, _omitFieldNames ? '' : 'activeSessions', $pb.PbFieldType.O3)
    ..a<$core.int>(3, _omitFieldNames ? '' : 'readySessions', $pb.PbFieldType.O3)
    ..aInt64(4, _omitFieldNames ? '' : 'healthReportCount')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  TurncoatRouteEvidence clone() => TurncoatRouteEvidence()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  TurncoatRouteEvidence copyWith(void Function(TurncoatRouteEvidence) updates) => super.copyWith((message) => updates(message as TurncoatRouteEvidence)) as TurncoatRouteEvidence;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static TurncoatRouteEvidence create() => TurncoatRouteEvidence._();
  TurncoatRouteEvidence createEmptyInstance() => create();
  static $pb.PbList<TurncoatRouteEvidence> createRepeated() => $pb.PbList<TurncoatRouteEvidence>();
  @$core.pragma('dart2js:noInline')
  static TurncoatRouteEvidence getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<TurncoatRouteEvidence>(create);
  static TurncoatRouteEvidence? _defaultInstance;

  @$pb.TagNumber(1)
  $fixnum.Int64 get rxProofCount => $_getI64(0);
  @$pb.TagNumber(1)
  set rxProofCount($fixnum.Int64 v) { $_setInt64(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasRxProofCount() => $_has(0);
  @$pb.TagNumber(1)
  void clearRxProofCount() => clearField(1);

  @$pb.TagNumber(2)
  $core.int get activeSessions => $_getIZ(1);
  @$pb.TagNumber(2)
  set activeSessions($core.int v) { $_setSignedInt32(1, v); }
  @$pb.TagNumber(2)
  $core.bool hasActiveSessions() => $_has(1);
  @$pb.TagNumber(2)
  void clearActiveSessions() => clearField(2);

  @$pb.TagNumber(3)
  $core.int get readySessions => $_getIZ(2);
  @$pb.TagNumber(3)
  set readySessions($core.int v) { $_setSignedInt32(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasReadySessions() => $_has(2);
  @$pb.TagNumber(3)
  void clearReadySessions() => clearField(3);

  @$pb.TagNumber(4)
  $fixnum.Int64 get healthReportCount => $_getI64(3);
  @$pb.TagNumber(4)
  set healthReportCount($fixnum.Int64 v) { $_setInt64(3, v); }
  @$pb.TagNumber(4)
  $core.bool hasHealthReportCount() => $_has(3);
  @$pb.TagNumber(4)
  void clearHealthReportCount() => clearField(4);
}
...
class OutboundInfo extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'OutboundInfo', package: const $pb.PackageName(_omitMessageNames ? '' : 'hcore'), createEmptyInstance: create)
    ...
    ..aOM<$8.Timestamp>(3, _omitFieldNames ? '' : 'urlTestTime', subBuilder: $8.Timestamp.create)
  ...
  @$pb.TagNumber(3)
  $8.Timestamp get urlTestTime => $_getN(2);
  @$pb.TagNumber(3)
  set urlTestTime($8.Timestamp v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasUrlTestTime() => $_has(2);
  @$pb.TagNumber(3)
  void clearUrlTestTime() => clearField(3);
  @$pb.TagNumber(3)
  $8.Timestamp ensureUrlTestTime() => $_ensure(2);
...
class ParseResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParseResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'hcore'), createEmptyInstance: create)
    ..e<$2.ResponseCode>(1, _omitFieldNames ? '' : 'responseCode', $pb.PbFieldType.OE, defaultOrMaker: $2.ResponseCode.OK, valueOf: $2.ResponseCode.valueOf, enumValues: $2.ResponseCode.values)
  ...
  @$pb.TagNumber(1)
  $2.ResponseCode get responseCode => $_getN(0);
  @$pb.TagNumber(1)
  set responseCode($2.ResponseCode v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class ChangeMartenSettingsRequest extends $pb.GeneratedMessage {
  factory ChangeMartenSettingsRequest({
    $core.String? martenSettingsJson,
  }) {
    final $result = create();
    if (martenSettingsJson != null) {
      $result.martenSettingsJson = martenSettingsJson;
    }
    return $result;
  }
  ChangeMartenSettingsRequest._() : super();
  factory ChangeMartenSettingsRequest.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory ChangeMartenSettingsRequest.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ChangeMartenSettingsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'hcore'), createEmptyInstance: create)
    ..aOS(1, _omitFieldNames ? '' : 'martenSettingsJson')
    ..hasRequiredFields = false
  ;
  ...
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  ChangeMartenSettingsRequest clone() => ChangeMartenSettingsRequest()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  ChangeMartenSettingsRequest copyWith(void Function(ChangeMartenSettingsRequest) updates) => super.copyWith((message) => updates(message as ChangeMartenSettingsRequest)) as ChangeMartenSettingsRequest;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static ChangeMartenSettingsRequest create() => ChangeMartenSettingsRequest._();
  ChangeMartenSettingsRequest createEmptyInstance() => create();
  static $pb.PbList<ChangeMartenSettingsRequest> createRepeated() => $pb.PbList<ChangeMartenSettingsRequest>();
  @$core.pragma('dart2js:noInline')
  static ChangeMartenSettingsRequest getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<ChangeMartenSettingsRequest>(create);
  static ChangeMartenSettingsRequest? _defaultInstance;

  @$pb.TagNumber(1)
  $core.String get martenSettingsJson => $_getSZ(0);
  @$pb.TagNumber(1)
  set martenSettingsJson($core.String v) { $_setString(0, v); }
  @$pb.TagNumber(1)
  $core.bool hasMartenSettingsJson() => $_has(0);
  @$pb.TagNumber(1)
  void clearMartenSettingsJson() => clearField(1);
}
...
class SelectOutboundRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'SelectOutboundRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'hcore'), createEmptyInstance: create)
    ...
    ..aOB(3, _omitFieldNames ? '' : 'skipProbe')
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $core.bool get skipProbe => $_getBF(2);
  @$pb.TagNumber(3)
  set skipProbe($core.bool v) { $_setBool(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasSkipProbe() => $_has(2);
  @$pb.TagNumber(3)
  void clearSkipProbe() => clearField(3);
}
