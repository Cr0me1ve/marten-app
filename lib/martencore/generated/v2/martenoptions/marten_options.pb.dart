...
import 'marten_options.pbenum.dart';

export 'marten_options.pbenum.dart';

/// *
///  MartenOptions defines the configuration options for the Marten application.
class MartenOptions extends $pb.GeneratedMessage {
  factory MartenOptions({
  ...
  MartenOptions._() : super();
  factory MartenOptions.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory MartenOptions.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);

  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MartenOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'martenoptions'), createEmptyInstance: create)
  ...
  MartenOptions clone() => MartenOptions()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  MartenOptions copyWith(void Function(MartenOptions) updates) => super.copyWith((message) => updates(message as MartenOptions)) as MartenOptions;

  $pb.BuilderInfo get info_ => _i;

  @$core.pragma('dart2js:noInline')
  static MartenOptions create() => MartenOptions._();
  MartenOptions createEmptyInstance() => create();
  static $pb.PbList<MartenOptions> createRepeated() => $pb.PbList<MartenOptions>();
  @$core.pragma('dart2js:noInline')
  static MartenOptions getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<MartenOptions>(create);
  static MartenOptions? _defaultInstance;
  ...
  @$pb.TagNumber(13)
  MuxOptions get mux => $_getN(10);
  @$pb.TagNumber(13)
  set mux(MuxOptions v) { setField(13, v); }
  @$pb.TagNumber(13)
  $core.bool hasMux() => $_has(10);
  @$pb.TagNumber(13)
  void clearMux() => clearField(13);
  @$pb.TagNumber(13)
  MuxOptions ensureMux() => $_ensure(10);

  @$pb.TagNumber(14)
  TLSTricks get tlsTricks => $_getN(11);
  @$pb.TagNumber(14)
  set tlsTricks(TLSTricks v) { setField(14, v); }
  @$pb.TagNumber(14)
  $core.bool hasTlsTricks() => $_has(11);
  @$pb.TagNumber(14)
  void clearTlsTricks() => clearField(14);
  @$pb.TagNumber(14)
  TLSTricks ensureTlsTricks() => $_ensure(11);

  @$pb.TagNumber(15)
  DNSOptions get dnsOptions => $_getN(12);
  @$pb.TagNumber(15)
  set dnsOptions(DNSOptions v) { setField(15, v); }
  @$pb.TagNumber(15)
  $core.bool hasDnsOptions() => $_has(12);
  @$pb.TagNumber(15)
  void clearDnsOptions() => clearField(15);
  @$pb.TagNumber(15)
  DNSOptions ensureDnsOptions() => $_ensure(12);

  @$pb.TagNumber(16)
  InboundOptions get inboundOptions => $_getN(13);
  @$pb.TagNumber(16)
  set inboundOptions(InboundOptions v) { setField(16, v); }
  @$pb.TagNumber(16)
  $core.bool hasInboundOptions() => $_has(13);
  @$pb.TagNumber(16)
  void clearInboundOptions() => clearField(16);
  @$pb.TagNumber(16)
  InboundOptions ensureInboundOptions() => $_ensure(13);

  @$pb.TagNumber(17)
  URLTestOptions get urlTestOptions => $_getN(14);
  @$pb.TagNumber(17)
  set urlTestOptions(URLTestOptions v) { setField(17, v); }
  @$pb.TagNumber(17)
  $core.bool hasUrlTestOptions() => $_has(14);
  @$pb.TagNumber(17)
  void clearUrlTestOptions() => clearField(17);
  @$pb.TagNumber(17)
  URLTestOptions ensureUrlTestOptions() => $_ensure(14);

  @$pb.TagNumber(18)
  RouteOptions get routeOptions => $_getN(15);
  @$pb.TagNumber(18)
  set routeOptions(RouteOptions v) { setField(18, v); }
  @$pb.TagNumber(18)
  $core.bool hasRouteOptions() => $_has(15);
  @$pb.TagNumber(18)
  void clearRouteOptions() => clearField(18);
  @$pb.TagNumber(18)
  RouteOptions ensureRouteOptions() => $_ensure(15);
}
...
class IntRange extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'IntRange', package: const $pb.PackageName(_omitMessageNames ? '' : 'martenoptions'), createEmptyInstance: create)
...
class DNSOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'DNSOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'martenoptions'), createEmptyInstance: create)
...
class InboundOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'InboundOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'martenoptions'), createEmptyInstance: create)
...
class URLTestOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'URLTestOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'martenoptions'), createEmptyInstance: create)
...
class RouteOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'RouteOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'martenoptions'), createEmptyInstance: create)
...
class TLSTricks extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'TLSTricks', package: const $pb.PackageName(_omitMessageNames ? '' : 'martenoptions'), createEmptyInstance: create)
...
class MuxOptions extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'MuxOptions', package: const $pb.PackageName(_omitMessageNames ? '' : 'martenoptions'), createEmptyInstance: create)
...
class Rule extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'Rule', package: const $pb.PackageName(_omitMessageNames ? '' : 'martenoptions'), createEmptyInstance: create)
