          ...
          children: [
            InkWell(
              ...
              child: Padding(
                ...
                child: IPCountryFlag(
                  countryCode: countryCodeFromTag(activeProxy.tag) ??
                      (activeProxy.ipinfo.countryCode.isNotEmpty
...
String getRealOutboundTag(OutboundInfo group) {
  ...
  if (group.hasGroupSelectedOutbound()) {
    final selectedTag = group.groupSelectedOutbound.tagDisplay;
