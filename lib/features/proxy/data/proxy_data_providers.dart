...
import 'package:marten/features/proxy/data/proxy_repository.dart';
...
ProxyRepository proxyRepository(Ref ref) {
  return ProxyRepositoryImpl(singbox: ref.watch(martenCoreServiceProvider), client: ref.watch(httpClientProvider));
}
