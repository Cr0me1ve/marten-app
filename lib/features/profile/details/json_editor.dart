...
const _downArrow = SizedBox(width: _expandIconWidth, child: Icon(Icons.keyboard_arrow_down, size: 14));
const _rightArrow = SizedBox(width: _expandIconWidth, child: Icon(Icons.keyboard_arrow_right, size: 14));
...
const Map<String, List<String>> possibleValues = {
  ...
  "config.endpoints.type": <String>["wireguard"],
};
