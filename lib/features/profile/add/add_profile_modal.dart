...
import 'package:marten/features/profile/add/widgets/widgets.dart';
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    useMemoized(() async {
      try {
        ...
        Logger.app.warning("error adding profile from import link", error, stackTrace);
      }
    });
    return SafeArea(
      child: isLoading
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        final initial = fixBtnsHeight + 32;
        var min = initial;
